...
1\. Open your browser and navigate to / Відкрийте браузер за адресою: `http://<YOUR\_RPI\_IP>:8123` (e.g., `http://192.168.1.4:8123`).
...
5\. Paste the contents from the `home-assistant/configuration\_snippet.yaml` file from this repository into the end of the file.

&#x20;  Вставте вміст файлу `home-assistant/configuration\_snippet.yaml` з цього репозиторію в кінець файлу.
