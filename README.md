...
!\[System Architecture Diagram](images/architecture\_diagram.png)
...
&#x20;  \* \*\*Home Assistant Core (Docker Container):\*\* Subscribes to the broker, extracts metrics using built-in YAML value templates, and maps them to unique entities (`unique\_id`).
